...
@if(isset($domat) && $domat instanceof \Illuminate\Support\Collection && $domat->isEmpty())
...
?>
                    ...
                    <tr class="odd gradeX" align="center">
                        <td><?php echo $i +=1; ?></td>
                        <td>{{ $dm->name }}</td>
                        <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="admin/danhmuc/domat/xoa/{{ $dm->id }}">Xoá</a></td>
                        <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="admin/danhmuc/domat/sua/{{ $dm->id }}">Sửa</a></td>
                    </tr>
                    @endforeach
                        </tbody>
                    </table>
