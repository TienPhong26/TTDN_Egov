...
?>
                                ...
                                @if(is_iterable($vanbannoibo) && count($vanbannoibo) > 0)
                                @foreach($vanbannoibo as $key => $value)
                                    <tr class="odd gradeX" align="center">
                                        ...
                                        <td>{{ $value->ghichu }}</td>
                                        <td class="center"><i class="fa fa-pencil fa-fw"></i> <a href="admin/vanbannoibo/pheduyetnoibo/{{ $value->id }}">Xử lý</a></td>
