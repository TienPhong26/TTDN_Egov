...
@section('title', 'Trình chuyển văn bản đi')
...
@section('content')
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Trình chuyển văn bản đi</h1>
                </div>
            </div>
            ...
            <form action="{{ route('admin.vanbandi.chuyenvbdi', ['id' => $vanbandi->id]) }}" method="POST">
                {{ csrf_field() }}
                ...
                <a href="{{ url('admin/vanbandi/chuyen') }}" class="btn btn-default" class="btn btn-primary"><i class="fa-solid fa-backward"></i> Quay lại</a>
            </form>
        </div>
        <div class="form-group">
            <br>
